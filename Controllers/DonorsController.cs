...
namespace GiftOfGivers_WebApplication.Controllers
{
    ...
    public class DonorsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("DonorID,Name,Email,Phone,CreatedAt")] Donor donor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("DonorID,Name,Email,Phone,CreatedAt")] Donor donor)
        {
            if (id != donor.DonorID)
            {
                return NotFound();
